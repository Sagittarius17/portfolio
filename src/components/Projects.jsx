        ...
        <div id="projects" className="pt-[69px]">
            ...
            <div className="grid grid-cols-1 m-8 sm:grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="p-4">
                        <h3 className="text-lg font-bold mb-2">Python Chatroom</h3>
                ...
                <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="p-4">
                        <h3 className="text-lg font-bold mb-2">Python P2P Text File Transfer</h3>
                        <p className="text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vestibulum ante ac velit vehicula, ut pellentesque enim efficitur.</p>
                ...
                <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="p-4">
                        ...
                        <p className="text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vestibulum ante ac velit vehicula, ut pellentesque enim efficitur.</p>
                        <a href="https://github.com/Sagittarius17/python-projects" className="text-blue-600 hover:text-blue-800 mt-2 inline-block">View project on Github</a>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="p-4">
                        <h3 className="text-lg font-bold mb-2">Simple PHP Authentication System</h3>
                        <p className="text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vestibulum ante ac velit vehicula, ut pellentesque enim efficitur.</p>
                        <a href="https://github.com/Sagittarius17/simple-php-authentication-system" className="text-blue-600 hover:text-blue-800 mt-2 inline-block">View project on Github</a>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                    <img src="https://github.com/Sagittarius17.png" alt="Project 4" className="w-full h-48 object-cover" />
                    <div className="p-4">
                        <h3 className="text-lg font-bold mb-2">Python-Django Weather App</h3>
                        <p className="text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vestibulum ante ac velit vehicula, ut pellentesque enim efficitur.</p>
                        <a href="https://github.com/Sagittarius17/python-django-weather-app" className="text-blue-600 hover:text-blue-800 mt-2 inline-block">View project</a>
                    </div>
                </div>
