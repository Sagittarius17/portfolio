...
const Welcome = () => {
  ...
  return (
    <section id='home' className="flex flex-col items-center justify-center h-screen md:h-screen bg-[#000]">
      ...
      <h1 className='sticky top-0 text-[#ff3030] text-center'>&#9888; This website is under construction! Please use laptop browser or active desktop-mode on mobile for better view.</h1>
