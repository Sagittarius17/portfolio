...
const Welcome = () => {
  ...
  return (
    <section id='home' className="flex flex-col items-center justify-center h-screen pt-[70px] bg-[#000]">
      <h2 className="flex relative w-[100%] bottom-[177px] sm:flex text-4xl text-white justify-center font-bold border-t-8 border-l-8 border-r-8 border-solid border-[#a0ff00] pt-6">WELCOME</h2>
      <h1 className='text-[#ff3030] text-center'>&#9888; This website is under construction!</h1>
      <div className="">
        <div className="text-black font-bold border-2 border-solid border-white text-center bg-green-500 p-2">Portfolio viewed {viewCount} times.</div>;
        <p className="text-sm text-white text-center mx-28">
