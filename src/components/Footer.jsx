...
function Footer() {
    ...
    return (
        <footer className="flex flex-col h-[300px] items-center bg-opacity-0 backdrop-blur-lg drop-shadow-lg bg-gradient-to-b from-red-600 to-indigo-900">
            ...
            <div className="flex absolute bottom-[50px] lg:flex-row-reverse items-center sm:flex-col sm:items-center sm:justify-between">
            ...
            <div className="flex fixed bottom-0 h-12 w-full mt-6 items-center justify-center sm:flex-row sm:items-center bg-black">
