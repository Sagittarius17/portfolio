...
function Footer() {
    ...
    // const connectLink = document.getElementById('social-media');

    // connectLink.addEventListener('click', () => {
    //     connectLink.classList.add('blink');
    //     setTimeout(() => {
    //         connectLink.classList.remove('blink');
    //     }, 1000);
    // });
    ...
    return (
        <footer className="flex flex-col items-center bg-opacity-0 backdrop-blur-lg drop-shadow-lg bg-gradient-to-b from-red-600 to-indigo-900">
            ...
            <div className="flex lg:flex-row-reverse items-center sm:flex-col sm:items-center sm:justify-between">
                <div id="social-media" className="blink flex sm:mt-3 lg:pl-[350px] sm:flex space-x-6 sm:justify-center">
