  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row justify-center items-center container mx-auto px-4 pt-24 md:pt-0" id="home">
      <div className="flex-1 text-center md:text-left">
        <h1 className="text-5xl md:text-8xl font-bold text-white">Welcome to my Portfolio</h1>
        <p className="text-xl md:text-2xl text-gray-300 mt-4">I'm a passionate developer creating beautiful and functional web applications.</p>
      ...
      {!isSmallScreen && (
        <div className="flex-1 h-full w-full mt-8 md:mt-0">
          <Canvas>
